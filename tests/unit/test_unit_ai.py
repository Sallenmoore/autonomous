...
class TestGeminiModel:
    ...
    def test_generate_audio(self):
        ...
        # log(result)
        assert result
        open("tests/assets/newaudio.mp3", "wb").write(result)
...
class TestAudioAgent:
    ...
    def test_generate_audio(self):
        ...
        prompt = "Let's split up. That's always a good plan."
    ...
    def test_generate_audio_text(self):
        ...
        with open("tests/assets/testaudio.mp3", "rb") as f:
            audio_bytes = f.read()
        result = ai.generate_text(audio_bytes)
        open("tests/assets/audio_text.txt", "w").write(result)
        assert os.path.exists("tests/assets/audio_text.txt")
